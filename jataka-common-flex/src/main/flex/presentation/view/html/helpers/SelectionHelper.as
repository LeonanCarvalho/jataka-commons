package presentation.view.html.helpers
{
	...
	public class SelectionHelper
	{
		...
		/**
		 * Returns an Array containing all ListItemElements that are at least 
		 * partially contained within the TextFlow's current selection state.
		 */
		public static function getSelectedListItems(tf:TextFlow, recurse:Boolean = true):Array 
		{
			return getSelectedElements(tf, null, [ListItemElement], recurse);
		}
